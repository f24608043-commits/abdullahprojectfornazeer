          ...
          {list.map((s, i) => (
            <Reveal key={s.title} delay={i * 0.04}>
              <motion.button
                ...
                onClick={() => setOpen(s)}
                className="group text-left w-full h-full bg-gray-100 rounded-[2rem] border border-gray-200 p-8 hover:shadow-2xl transition-all duration-500 relative overflow-hidden"
              >
...
<span className="text-[11px] uppercase tracking-[0.3em] text-blue-500">
                  ...
                  <h3 className="mt-7 text-2xl font-bold leading-snug text-black">{s.title}</h3>

                  <p className="mt-4 text-blue-600 leading-relaxed">{s.short}</p>
