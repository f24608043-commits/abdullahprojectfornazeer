                                ...
                                <div key={booking.id} className="bg-white rounded-lg shadow p-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <p className="text-sm">{booking.preferred_date} at {booking.preferred_time}</p>
                                        </div>
                                        <div>
                                    ...
                                    {(booking.previous_treatment || booking.medical_conditions || booking.additional_notes) && (
                                        <div className="text-sm text-gray-600">
                                            {booking.previous_treatment && (
                                                <p className="mb-2"><strong>Previous Treatment:</strong> {booking.previous_treatment}</p>
                                            )}
                                            {booking.medical_conditions && (
                                                <p className="mb-2"><strong>Medical Conditions:</strong> {booking.medical_conditions}</p>
                                            )}
