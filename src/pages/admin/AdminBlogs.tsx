...
import { getAdminBlogs, createBlog, updateBlog, deleteBlog } from "../../api/adminApi";
      ...
      <div className="p-8">
        ...
        {showForm ? (
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            <h2 className="text-xl font-semibold mb-6">{editId ? "Edit Blog" : "Add New Blog"}</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">SEO Slug *</label>
                <input
                  type="text"
                  value={form.seo_slug}
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Title Image URL</label>
                <input
                  type="url"
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Enter your blog content in HTML format</p>
              </div>
            ...
            <tbody className="divide-y divide-gray-200">
              {blogs.map((blog) => (
                <tr key={blog.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500">{blog.seo_slug}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
