...
export function Footer() {
  return (
    <footer className="relative mt-32 bg-charcoal text-white">
      {" "}
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-20 grid gap-14 md:grid-cols-4">
        ...
        {/* CONTACT */}
        <div>
          <p className="text-xs uppercase tracking-[0.25em] text-gold-soft">Contact</p>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/50">
          ...
          <p className="tracking-[0.25em] uppercase">Crafted with quiet precision</p>
        </div>
      </div>
    </footer>
  );
