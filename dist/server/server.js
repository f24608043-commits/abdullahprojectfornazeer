...
<html lang="en">
  <head>
    ...
    <style>
      body { font: 15px/1.5 system-ui, -apple-system, sans-serif; background: #e0f2fe; color: #111; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
...
async function getServerEntry() {
  if (!serverEntryPromise) {
    serverEntryPromise = import("./assets/server-CW_FSV57.js").then((n) => n.s).then(
      (m) => m.default ?? m
    );
  }
