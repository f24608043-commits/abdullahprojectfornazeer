...
import { R as Route } from "./router-jex_bHBP.js";
...
function BlogDetailPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "pt-32 pb-24", children: /* @__PURE__ */ jsx("section", { className: "mx-auto max-w-4xl px-6 lg:px-10", children: /* @__PURE__ */ jsxs(Reveal, { children: [
    /* @__PURE__ */ jsxs(Link, { to: "/education", className: "inline-flex items-center gap-2 text-sm text-gray-600 hover:text-red-600 transition-colors mb-8", children: [
