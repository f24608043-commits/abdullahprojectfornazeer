...
const appCss = "/assets/styles-COKhfgRm.css";
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed inset-x-0 top-0 z-50 bg-white border-b border-gray-200 shadow-sm transition-all duration-500", children: [
        ...
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-col leading-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl tracking-wide text-charcoal", children: "              NMDC" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.25em] text-muted-foreground", children: "Nazeer Maxillofacial & Dental Center" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-10", children: links.map((l) => l.label === "Book Appointment" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: l.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mt-32 bg-charcoal text-white", children: [
    "      ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 hairline" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10 py-20 grid gap-14 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full border border-gold/40 font-display text-gold", children: "              N" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl", children: "NMDC" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.3em] text-white/60", children: "                Nazeer Maxillofacial & Dental Center" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-md text-sm leading-relaxed text-white/70", children: "            Led by Brig Dr Muhammad Nazeer Khan — BDS, MCPS, FCPS — with advanced fellowships in maxillofacial surgery and medical education (MHPE, IPPCR), and serving as Member & Regional Faculty of AOCMF / AOPEER (Switzerland). NMDC represents a standard of precision-driven care in oral and maxillofacial surgery, combining international training, modern surgical techniques, and a deeply patient-centered approach to treatment and recovery." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gold-soft", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-6 space-y-3 text-sm text-white/80", children: [
          ...
          [
            ...
            { to: "/reviews", label: "Reviews" },
            { to: "/contact", label: "Contact" }
          ].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: l.to, className: "hover:text-gold transition-colors", children: [
            "                  ",
            l.label
          ] }) }, l.to))
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.25em] text-gold-soft", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-6 space-y-5 text-sm text-white/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "mt-0.5 h-4 w-4 text-red-600 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.2em] text-white/40", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:0512715959", className: "mt-1 inline-block hover:text-gold", children: "                  051 2715959" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "mt-0.5 h-4 w-4 text-red-600 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.2em] text-white/40", children: "                  WhatsApp" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "mt-0.5 h-4 w-4 text-red-600 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.2em] text-white/40", children: "                  Email" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "mt-0.5 h-4 w-4 text-red-600 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.2em] text-white/40", children: "                  Address" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex flex-wrap items-center gap-2 text-center md:text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tracking-[0.25em] uppercase", children: "Crafted with quiet precision" })
    ] }) })
  ] });
}
function WhatsAppButton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -inset-1 rounded-full bg-[#25D366]/30 animate-ping" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 32 32",
            ...
            fill: "currentColor",
            "aria-hidden": "true",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19.11 17.39c-.27-.14-1.6-.79-1.85-.88-.25-.09-.43-.14-.61.14-.18.27-.7.88-.86 1.06-.16.18-.32.2-.59.07-.27-.14-1.14-.42-2.17-1.34-.8-.71-1.34-1.59-1.5-1.86-.16-.27-.02-.41.12-.55.12-.12.27-.32.41-.48.14-.16.18-.27.27-.45.09-.18.05-.34-.02-.48-.07-.14-.61-1.47-.84-2.01-.22-.53-.45-.46-.61-.47l-.52-.01c-.18 0-.48.07-.73.34-.25.27-.96.94-.96 2.29 0 1.35.99 2.66 1.13 2.84.14.18 1.95 2.97 4.72 4.17.66.28 1.18.45 1.58.58.66.21 1.26.18 1.74.11.53-.08 1.6-.65 1.83-1.28.23-.62.23-1.16.16-1.28-.07-.12-.25-.18-.52-.32zM16.01 3C8.83 3 3 8.82 3 16c0 2.54.74 5 2.13 7.11L3 29l6.08-2.04A12.9 12.9 0 0 0 16.01 29C23.18 29 29 23.18 29 16S23.18 3 16.01 3z" })
          }
        ) })
      ]
    }
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground", children: "Go home" }) })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex gap-2 justify-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium text-foreground", children: "Go home" })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$f = () => import("./services-IafQXiHF.js");
...
const $$splitComponentImporter$e = () => import("./reviews-WxhU7wLM.js");
const Route$g = createFileRoute("/reviews")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$d = () => import("./education-DrYYpxVf.js");
const Route$f = createFileRoute("/education")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./contact-B0h8kH24.js");
...
const $$splitComponentImporter$b = () => import("./bookappointment-DXYew8il.js");
const Route$d = createFileRoute("/bookappointment")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$a = () => import("./index-Di7VRRN6.js");
...
const Route$b = createFileRoute("/brigaidear/")({
  beforeLoad: () => {
...
const $$splitComponentImporter$9 = () => import("./videos-BwuWQ-eB.js");
const Route$9 = createFileRoute("/brigaidear/videos")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./reviews-BkxNmcwW.js");
const Route$8 = createFileRoute("/brigaidear/reviews")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-CEKbTOj5.js");
const Route$7 = createFileRoute("/brigaidear/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./dashboard-Dy_hcXJy.js");
const Route$6 = createFileRoute("/brigaidear/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./_layout-BKwcj9S_.js");
const Route$5 = createFileRoute("/brigaidear/_layout")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./videos-DumxNF6u.js");
const Route$4 = createFileRoute("/admin/videos")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./reviews-BXGb8qFn.js");
const Route$3 = createFileRoute("/admin/reviews")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./login-CbKFYDxs.js");
const Route$2 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard-BDCrSb7k.js");
const Route$1 = createFileRoute("/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_layout-B-LpjsVI.js");
const Route2 = createFileRoute("/admin/_layout")({
...
const ReviewsRoute = Route$g.update({
  id: "/reviews",
  path: "/reviews",
  getParentRoute: () => Route$i
});
const EducationRoute = Route$f.update({
  id: "/education",
  path: "/education",
  getParentRoute: () => Route$i
});
...
const BookappointmentRoute = Route$d.update({
  id: "/bookappointment",
...
const BrigaidearIndexRoute = Route$b.update({
  id: "/brigaidear/",
  path: "/brigaidear/",
  getParentRoute: () => Route$i
});
...
const BrigaidearVideosRoute = Route$9.update({
  id: "/brigaidear/videos",
  path: "/brigaidear/videos",
  getParentRoute: () => Route$i
});
const BrigaidearReviewsRoute = Route$8.update({
  id: "/brigaidear/reviews",
  path: "/brigaidear/reviews",
  getParentRoute: () => Route$i
});
const BrigaidearLoginRoute = Route$7.update({
  id: "/brigaidear/login",
  path: "/brigaidear/login",
  getParentRoute: () => Route$i
});
const BrigaidearDashboardRoute = Route$6.update({
  id: "/brigaidear/dashboard",
  path: "/brigaidear/dashboard",
  getParentRoute: () => Route$i
});
const BrigaidearLayoutRoute = Route$5.update({
...
const AdminLayoutRoute = Route2.update({
  id: "/admin/_layout",
  path: "/admin",
  getParentRoute: () => Route$i
});
...
export {
  ...
  animateSingleValue as d,
  animateTarget as e,
  cancelFrame as f,
  collectMotionValues as g,
  createBox as h,
  createGeneratorEasing as i,
  ...
  isMotionValue as q,
  isSVGElement as r,
  isSVGSVGElement as s,
  mixNumber$1 as t,
  motion as u,
  motionValue as v,
  progress as w,
  removeItem as x,
  resolveElements as y,
  reverseEasing as z
};
