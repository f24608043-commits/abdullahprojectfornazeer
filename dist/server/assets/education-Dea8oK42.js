...
function EducationPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 to-white", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8", children: filteredArticles.map((a, idx) => /* @__PURE__ */ jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
        ...
        /* @__PURE__ */ jsxs("div", { onClick: () => setSelectedArticle(a), className: "flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { children: selectedArticle && /* @__PURE__ */ jsx(motion.div, { className: "fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-6 z-50", initial: {
      opacity: 0
    }, animate: {
      opacity: 1
    }, exit: {
      opacity: 0
    }, onClick: () => setSelectedArticle(null), children: /* @__PURE__ */ jsxs(motion.div, { className: "bg-white w-full max-w-4xl max-h-[85vh] overflow-y-auto p-10 rounded-2xl relative", initial: {
      scale: 0.92,
      opacity: 0
    }, animate: {
      scale: 1,
      ...
      /* @__PURE__ */ jsx("button", { onClick: () => setSelectedArticle(null), className: "absolute top-6 right-6 w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-red-600 hover:text-white transition", children: /* @__PURE__ */ jsx(X, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsx("span", { className: "bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-semibold inline-block", children: selectedArticle.cat }),
      /* @__PURE__ */ jsx("h2", { className: "mt-6 text-4xl font-bold leading-tight text-gray-900", children: selectedArticle.title }),
      /* @__PURE__ */ jsx("p", { className: "mt-8 text-gray-700 leading-8 text-lg", children: selectedArticle.content })
    ] }) }) })
  ] });
}
export {
