...
function EducationPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 to-white", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8", children: filteredArticles.map((a, idx) => /* @__PURE__ */ jsx(Link, { to: a.seo_slug ? `/blogs/${a.seo_slug}` : `/blogs`, className: "group cursor-pointer", children: /* @__PURE__ */ jsxs(motion.div, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
