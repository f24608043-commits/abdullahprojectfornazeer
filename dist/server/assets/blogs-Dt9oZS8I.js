...
import { k as getAdminBlogs, x as updateBlog, c as createBlog, f as deleteBlog } from "./adminApi-BjrAEKnx.js";
...
function AdminBlogs() {
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsxs("div", { className: "p-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold", children: "Blogs Management" }),
    ...
    showForm ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow p-6 mb-8", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold mb-6", children: editId ? "Edit Blog" : "Add New Blog" }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-2", children: "Title *" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-2", children: "SEO Slug *" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-2", children: "Title Image URL" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "url",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-2", children: "Excerpt" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              value: form.excerpt,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium mb-2", children: "HTML Content *" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Enter your blog content in HTML format" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("label", { htmlFor: "is_published", className: "text-sm font-medium", children: "Publish immediately" })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow overflow-hidden", children: [
      /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: blogs.map((blog) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-gray-900", children: blog.title }),
            blog.title_image_url && /* @__PURE__ */ jsx(
              "img",
              {
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: blog.seo_slug }) }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `px-2 py-1 text-xs rounded-full ${blog.is_published ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`, children: blog.is_published ? "Published" : "Draft" }) }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: new Date(blog.created_at).toLocaleDateString() }),
      ...
      blogs.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-center py-12 text-gray-500", children: 'No blogs yet. Click "Add New Blog" to create one.' })
    ] })
  ] }) });
}
